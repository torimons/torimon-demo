...
export default class Search {
    ...
    private targetSpots: RawSpotData[];

    constructor(spots: RawSpotData[]) {
     ...
     */
    public searchSpots(keyword: string | null): RawSpotData[] {
     ...
     */
    private spotIsMatchToKeywords(spot: RawSpotData, keywordsRegExp: RegExp): boolean {
